...
<p align="center">
  ...
  <br>
  <b>Figure 3:</b> The process of treating pitch extraction as a regression problem, where the L1 loss function is used to minimize the difference between predicted and actual pitch values.
</p>
