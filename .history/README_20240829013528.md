...
<p align="center">
  <img src="image.png" alt="Perform Inverse Short-Time Fourier Transform to Get the Estimated Target Speech">
  <br>
  <b>Figure 5:</b> Performing inverse short-time Fourier transform (iSTFT) on the estimated magnitude spectrogram and mixed phase spectrogram to obtain the estimated target speech.
</p>
